...
export const openHours: OpenHours[] = [
  { days: { fr: 'Dimanche – Mercredi', en: 'Sunday – Wednesday' }, hours: { fr: '11h – 21h', en: '11am – 9pm' } },
  { days: { fr: 'Jeudi – Samedi', en: 'Thursday – Saturday' }, hours: { fr: '11h – 22h', en: '11am – 10pm' } },
]
...
export const siteAlert = {
  ...
  en: "Please note! This site is generated by AI, and the pizzeria does not actually exist. If you would like to learn how to create a site like this, contact us at info@hubformation.ca.",
}

export const orderAlert = {
  fr: "Attention! Ce site est un site démo créé par intelligence artificielle. Aucune commande ne sera livrée.",
  en: "Please note! This is a demo site created by artificial intelligence. No orders will be delivered.",
}
